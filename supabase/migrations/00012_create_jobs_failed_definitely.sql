...
CREATE INDEX idx_jobs_failed_definitely_profile_id ON jobs_failed_definitely (profile_id);
CREATE INDEX idx_jobs_failed_definitely_error_code ON jobs_failed_definitely (error_code);
CREATE INDEX idx_jobs_failed_definitely_last_attempt_at ON jobs_failed_definitely (last_attempt_at DESC);
CREATE INDEX idx_jobs_failed_definitely_reviewed ON jobs_failed_definitely (reviewed_at) WHERE reviewed_at IS NULL;
